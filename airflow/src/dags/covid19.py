...
connection_id = default_args['connection_id']

with DAG(dag_id="covid19", default_args=default_args, schedule_interval="@daily") as dag:
    ingest_covid19_day_task = Covid19ToIngestions(task_id='ingest_covid19_day', dag=dag, connection_id=connection_id)
    transform_and_load_covid19_day_task = Covid19ToAnalytics(task_id='transform_covid19_day', dag=dag, connection_id=connection_id)
